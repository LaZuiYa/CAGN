...
if __name__ == "__main__":
    ...
    if args.debug:
        args.epochs = 1
    save_name = args.method_name + 'lr' + str(int(args.lr*1000)) + 'num_filters' + str(int(args.num_filter)) + 'heads' + str(int(args.heads))+ 'task' + str(int(args.task)) + 'link' + str(int(args.num_class_link))
