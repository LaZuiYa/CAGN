...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='pubmed', help='data set selection')
    ...
    parser.add_argument('--layer', type=int, default=2, help='How many layers of gcn in the model, default 2 layers.')   ###teletram 2
