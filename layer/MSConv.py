...
class MSConv(MessagePassing):
    ...
    def __norm__(
        ...
        edge_weight_real = (2.0 * edge_weight_real.to('cuda')) / lambda_max
        ...
        edge_weight_imag = (2.0 * edge_weight_imag.to('cuda')) / lambda_max
    ...
    def forward(
        ...
        edge_index_real = edge_index_real.to('cuda')
        edge_index_imag = edge_index_imag.to('cuda')
