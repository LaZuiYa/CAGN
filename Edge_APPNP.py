...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='citeseer/', help='data set selection')
    ...
    parser.add_argument('--task', type=int, default=2, help='2: existence others: direction')
...
if __name__ == "__main__":
    ...
    if args.debug:
        args.epochs = 1
    save_name = args.method_name + 'lr' + str(int(args.lr*1000)) + 'num_filters' + str(int(args.num_filter)) + 'alpha' + str(int(100*args.alpha)) + 'K' + str(int(args.K)) + 'task' + str(int(args.task)) + 'link' + str(int(args.num_class_link))
